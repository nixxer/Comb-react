...
class form extends React.Component {
  ...
  success = (msg) => {
      if(msg.error && (msg.error.statusCode >= 400 && msg.error.statusCode < 600 ))
           message.error(`No se ha podido crear el vehículo ${this.state.marca}`);
      else{
             message.success(`El vehículo ${this.state.marca} se ha creado con exito`);
             setTimeout(()=>{
      ...
      <div>
        ...
        <form>
          ...
          <MDBRow>
            ...
            <Button onClick={this.sendForm} type="primary">Crear</Button>
